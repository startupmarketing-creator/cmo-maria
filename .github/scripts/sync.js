...
// Extract both start and end date from a date property
function propToDateRange(prop) {
...
// Prefer the title-type property for company name
...
const dateRange = dateProp ? propToDateRange(dateProp) : { start: '', end: '' };
...
return { cover, date, endDate, jobTitle, company, desc, body, references };
}));
